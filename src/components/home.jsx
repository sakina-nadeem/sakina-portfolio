      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="container mx-auto px-6 lg:px-12 z-10">
          <div className="max-w-4xl mx-auto text-center md:text-left">
            ...
            >
              I build professional, high-performance web applications that deliver exceptional user experiences through clean, maintainable code.
            </motion.p>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row justify-between items-end md:items-center mb-16">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              <a href="#" className="text-blue-400 hover:text-blue-300 text-sm inline-flex items-center gap-2 transition-colors">
                View All Projects
        ...
        <div className="container mx-auto px-6 lg:px-12 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              I'm currently available for freelance projects and new collaborations.
              If you have a project that needs a professional developer, I'd love to discuss it.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
